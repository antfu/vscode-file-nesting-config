...
const dotnetProject = ['*proj.user', '*.config', 'appsettings.*', 'bundleconfig.json'];
...
const phoenixLiveView = ['$(capture).html.eex', '$(capture).html.leex', '$(capture).html.heex'];
...
const full = sortObject({
    ...
    ...Object.fromEntries(
        Object.entries(frameworks).map(([n, i]) => [n, stringify([...i, ...libraries])]),
    ),
    ...svelteKitRouting,
});
