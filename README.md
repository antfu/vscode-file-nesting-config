...
```jsonc
  ...
  "explorer.experimental.fileNesting.patterns": {
    ...
    "package.json": ".circleci*, .editorconfig, .eslint*, .gitlab-*.yml, .gitpod*, .markdownlint*, .node-version, .nodemon*, .npm*, .nvmrc, .prettier*, .sentryclirc, .stackblitz, .stylelintrc, .tazerc*, .travis.yml, .vscode*, .watchman*, .yamllint, .yarnrc*, babel.config.*, build.config.*, commitlint.config, cypress.json, jsconfig.*, lerna.json, lint-staged.config, netlify.toml, package-lock.json, pnpm-*, renovate.*, tsconfig.*, turbo.json, vercel.*, vetur.config.*, yarn.lock",
