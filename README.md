...
```jsonc
  ...
  "explorer.experimental.fileNesting.patterns": {
    ...
    "package.json": ".browserslistrc, .circleci*, .editorconfig, .eslint*, .gitpod*, .markdownlint*, .node-version, .nodemon*, .npm*, .nvmrc, .prettier*, .sentryclirc, .stackblitz, .tazerc*, .travis.yml, .vscode*, .watchman*, .yarnrc*, babel.config.*, build.config.*, commitlint.config, gulp.*, jsconfig.*, lerna.json, lint-staged.config, netlify.toml, package-lock.json, pnpm-*, renovate.*, stylelint.config.*, svgo.config.*, tsconfig.*, turbo.json, vercel.*, vetur.config.*, yarn.lock",
